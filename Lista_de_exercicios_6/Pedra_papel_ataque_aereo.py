...
def processaJogo():
    jogador1 = input()
    jogador2 = input()
    if (jogador1 + jogador2).count("ataque") > 0:
        if jogador1 == jogador2:
            return "Aniquilacao mutua"
        else:
            return "Jogador 1 venceu" if jogador1 == "ataque" else "Jogador 2 venceu"
    elif (jogador1 + jogador2).count("pedra"):
        if jogador1 == jogador2:
            return "Sem ganhador"
        else:
            return "Jogador 1 venceu" if jogador1 == "pedra" else "Jogador 2 venceu"
